...
*/
for (i = 1; i <= 100; i++) {
  if (i % 5 == 0 && i % 3 == 0) console.log(i + " число - делится и на 3 на 5");
  else if (i % 5 == 0) {
    console.log(i + " число - делится на 5");
  } else if (i % 3 == 0) {
    console.log(i + " число - делится на 3");
  } else {
    console.log(i + " число не делится на 3 или 5");
  }
}
