...
// let result = users.filter((item) => item.registrationDate == "09.10.2021");

const result = users.filter(function (e) {
  return (
    e.registrationDate == "09.10.2021" || e.registrationDate == "10.10.2021"
  );
});
console.log(result);
